...
module.exports = {
  ...
  serverRuntimeConfig: {
    ...
    deliverySolutions: {
      ...
      x_api_key: process.env.NEXT_PUBLIC_DELIVERYSOLUTIONS_X_API_KEY,
      tenantId: process.env.NEXT_PUBLIC_DELIVERYSOLUTIONS_TENANTID || 'kibo',
      store_external_id: process.env.NEXT_PUBLIC_DELIVERYSOLUTIONS_STORE_EXTERNAL_ID || '002',
      window_type: process.env.NEXT_PUBLIC_DELIVERYSOLUTIONS_WINDOW_TYPE || 'delivery',
      order_external_id: process.env.NEXT_PUBLIC_DELIVERYSOLUTIONS_ORDER_EXTERNAL_ID || '',
    },
  },
