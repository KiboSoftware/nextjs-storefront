...
import { useUpdateMultiShipCheckoutPersonalInfoMutation, useShippingMethodsQueries } from '@/hooks'
...
const StandardShippingStep = (props: ShippingProps) => {
  ...
  const updateCheckoutShippingInfo = useUpdateMultiShipCheckoutPersonalInfoMutation()
