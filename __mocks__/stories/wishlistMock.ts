...
export const wishlistMock: Maybe<WishlistCollection> | any = {
  items: [
    ...
    },
    {
      customerAccountId: 1143,
      name: 'Wishlist 1',
      id: '13cc2e5236615b000102f572000045b5',
      auditInfo: {
        createBy: 'abc@kibocommerce.com',
        createDate: new Date().getTime(),
      },
      items: [
        {
          id: '3a766637bfb04a9b87efaed200e191e4',
          quantity: 1,
          total: 475,
          subtotal: 475,
          product: {
    ...
    },
    {
      customerAccountId: 1143,
      name: 'Wishlist 2',
      id: '13cc2e5236615b000102f572000045c6',
      auditInfo: {
        createBy: 'abc@kibocommerce.com',
        createDate: new Date().getTime(),
      },
      items: [
        {
          id: '3a766637bfb04a9b87efaed200e191f5',
          quantity: 1,
          total: 475,
          subtotal: 475,
          product: {
    ...
    },
    {
      ...
      items: [
        {
          id: '3a766637bfb04a9b87efaed200e191g6',
          quantity: 1,
          total: 475,
          subtotal: 475,
          product: {
